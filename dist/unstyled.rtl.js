module.exports = {
    ...
    ".breadcrumbs": { maxWidth: "100%", overflowX: "auto" },
    ".breadcrumbs>ul": {
        display: "flex",
        alignItems: "center",
        whiteSpace: "nowrap",
    ...
    ".btn-disabled,.btn[disabled]": { pointerEvents: "none" },
    ...
    ".card-body": { display: "flex", flex: "1 1 auto", flexDirection: "column" },
    ...
    ".card.image-full:before": { position: "relative", content: '""' },
    ...
    ".footer>*": { display: "grid", placeItems: "start" },
    ...
    "@media (min-width:640px)": { ".modal": { alignItems: "center" } },
    ".modal-box": { maxHeight: "calc(100vh - 5em)" },
    ...
    ".select:focus": { outline: "2px solid transparent", outlineOffset: "2px" },
    ".select-disabled,.select[disabled]": { pointerEvents: "none" },
    ...
    ".stack>:nth-child(1)": { transform: "translateY(0) scale(1)", zIndex: "3" },
    ".stats": { display: "inline-grid" },
    ":where(.stats)": { gridAutoFlow: "column" },
    ".stat": {
        display: "inline-grid",
        width: "100%",
    ...
    ".stat-title": { gridColumnStart: "1", whiteSpace: "nowrap" },
    ".stat-value": { gridColumnStart: "1", whiteSpace: "nowrap" },
    ".stat-desc": { gridColumnStart: "1", whiteSpace: "nowrap" },
    ".stat-actions": { gridColumnStart: "1", whiteSpace: "nowrap" },
    ".steps": {
        display: "inline-grid",
        gridAutoFlow: "column",
        overflow: "hidden",
    ...
    ".swap>*": { gridColumnStart: "1", gridRowStart: "1" },
