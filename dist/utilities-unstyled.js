module.exports = {
    ...
    ".card-side figure>*": { maxWidth: "unset" },
    ":where(.card-sidefigure>*)": {
        width: "100%",
        height: "100%",
        objectFit: "cover",
    },
    ...
    ".divider-horizontal": { flexDirection: "column" },
    ".divider-horizontal:before": { height: "100%", width: ".125rem" },
    ".divider-horizontal:after": { height: "100%", width: ".125rem" },
    ".divider-vertical": { flexDirection: "row" },
    ".divider-vertical:before": { height: ".125rem", width: "100%" },
    ".divider-vertical:after": { height: ".125rem", width: "100%" },
    ".input-md": {
        height: "3rem",
        paddingLeft: "1rem",
        paddingRight: "1rem",
    ...
    ".menu-vertical": { flexDirection: "column" },
    ".menu-vertical :where(li)": { flexDirection: "column" },
    ...
    ".stats-horizontal": { gridAutoFlow: "column" },
    ".stats-vertical": { gridAutoFlow: "row" },
    ".steps-horizontal": {
        gridAutoColumns: "1fr",
        display: "inline-grid",
        gridAutoFlow: "column",
    ...
    ".steps-vertical": { gridAutoRows: "1fr", gridAutoFlow: "row" },
    ".steps-vertical .step": {
        display: "grid",
    ...
    ".toggle-xs": { "-Handleoffset": "0.5rem", height: "1rem", width: "1.5rem" },
    ".toggle-sm": {
