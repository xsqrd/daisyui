module.exports = {
    ...
    ".menu>:where(li)>:where(ul) :where(li) :where(ul)": { paddingLeft: "1rem" },
    ...
    ".mockup-code pre": { paddingRight: "1.25rem" },
    ...
    ".tab-lifted.tab-active:first-child:before": { background: "0 0" },
    ".tab-lifted.tab-active:last-child:after": { background: "0 0" },
    ".tab-lifted.tab-active+.tab-lifted.tab-active:before": { background: "0 0" },
    ".tabs-boxed": {
        "-TwBgOpacity": "1",
        backgroundColor: "hsl(var(--b2,var(--b1)) / var(--tw-bg-opacity))",
        padding: ".25rem",
