module.exports = {
    ...
    ".alert>:where(*)": { display: "flex", alignItems: "center", gap: ".5rem" },
    ".artboard": { width: "100%" },
    ".avatar": { position: "relative", display: "inline-flex" },
    ".avatar>div": { display: "block", aspectRatio: "1/1", overflow: "hidden" },
    ".avatar img": { height: "100%", width: "100%", objectFit: "cover" },
    ...
    ".breadcrumbs>ul>li>a:hover": { textDecorationLine: "underline" },
    ".btn": {
        display: "inline-flex",
        flexShrink: "0",
        cursor: "pointer",
        ...
        alignItems: "center",
        justifyContent: "center",
        borderColor: ["transparent", "hsl(var(--n) / var(--tw-border-opacity))"],
        textAlign: "center",
        transitionProperty:
            "color,background-color,border-color,text-decoration-color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter",
        transitionDuration: ".2s",
    ...
    "@media (prefers-reduced-motion:reduce)": {
        ".btn.loading:before": { animation: "spin 10s linear infinite" },
    },
    "@keyframes spin": {
    ...
    ".card.image-full>figure img": { height: "100%", objectFit: "cover" },
    ...
    "@media (min-width:1024px)": [
        {
            ".drawer-mobile": { gridAutoColumns: "max-content auto" },
    ...
    ".dropdown-end .dropdown-content": { left: "0" },
    ...
    ".input-group": { display: "flex", width: "100%", alignItems: "stretch" },
    ".input-group>*,.input-group>.input": { borderRadius: "0" },
    ".input-group-md": { fontSize: ".875rem", lineHeight: ["1.25rem", "2"] },
    ".input-group-lg": { fontSize: "1.125rem", lineHeight: ["1.75rem", "2"] },
    ".input-group-sm": { fontSize: ".875rem", lineHeight: "2rem" },
    ".input-group-xs": { fontSize: ".75rem", lineHeight: ["1rem", "1.625"] },
    ...
    ".input-group :last-child": {
        ...
        borderTopLeftRadius: "var(--rounded-btn,.5rem)",
        borderBottomRightRadius: "0",
        borderBottomLeftRadius: "var(--rounded-btn,.5rem)",
    },
    ".input-group-vertical": { flexDirection: "column" },
    ...
    ".link": { cursor: "pointer", textDecorationLine: "underline" },
    ".link-hover": { textDecorationLine: "none" },
    ".link-hover:hover": { textDecorationLine: "underline" },
    ".mask": {
    ...
    ".radial-progress:after": {
        ...
        transform:
            "rotate(calc(-1*(var(--value) * 3.6deg - 90deg))) translate(calc(-1*(var(--size)/ 2 - 50%)))",
    ...
    ".select": {
        ...
        backgroundPosition:
            "calc(100% - (100% - 20px)) calc(1px + 50%),calc(100% - (100% - 16px)) calc(1px + 50%)",
        backgroundSize: "4px 4px,4px 4px",
        backgroundRepeat: "no-repeat",
    },
    ".select:focus": {
        outline: ["2px solid transparent", "2px solid hsla(var(--bc) / .2)"],
    ...
    ":where(.stats)": { gridAutoFlow: "column", overflowX: "auto" },
    ".stat": {
        display: "inline-grid",
        width: "100%",
    ...
    ".stat-title": { gridColumnStart: "1", whiteSpace: "nowrap", opacity: ".6" },
    ".stat-value": {
        gridColumnStart: "1",
        whiteSpace: "nowrap",
        fontSize: "2.25rem",
    ...
    ".table": { position: "relative", textAlign: "right" },
    ...
    ".toggle": {
        ...
        boxShadow:
            "calc(-1*(var(--handleoffset) * -1)) 0 0 2px hsl(var(--b1)) inset,0 0 0 2px hsl(var(--b1)) inset",
    },
    ".tooltip": {
    ...
    ".input-info": {
        "-TwBorderOpacity": "1",
        borderColor: "hsl(var(--inc,var(--nc)) / var(--tw-border-opacity))",
    },
    ".input-info:focus": { outline: "2px solid hsl(var(--inc))" },
    ".input-success": {
        "-TwBorderOpacity": "1",
        borderColor: "hsl(var(--suc,var(--nc)) / var(--tw-border-opacity))",
    },
    ".input-success:focus": { outline: "2px solid hsl(var(--suc))" },
    ".input-warning": {
        "-TwBorderOpacity": "1",
        borderColor: "hsl(var(--wac,var(--nc)) / var(--tw-border-opacity))",
    },
    ".input-warning:focus": { outline: "2px solid hsl(var(--wac))" },
    ".input-error": {
        "-TwBorderOpacity": "1",
        borderColor: "hsl(var(--erc,var(--nc)) / var(--tw-border-opacity))",
    },
    ".input-error:focus": { outline: "2px solid hsl(var(--erc))" },
    ...
    ".mask-squircle": {
        WebkitMaskImage:
            "url(data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAwIiBoZWlnaHQ9IjIwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KCiAgPHBhdGggZD0iTSAxMDAgMCBDIDIwIDAgMCAyMCAwIDEwMCBDIDAgMTgwIDIwIDIwMCAxMDAgMjAwIEMgMTgwIDIwMCAyMDAgMTgwIDIwMCAxMDAgQyAyMDAgMjAgMTgwIDAgMTAwIDAgWiIvPgoKPC9zdmc+)",
        maskImage:
            "url(data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAwIiBoZWlnaHQ9IjIwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KCiAgPHBhdGggZD0iTSAxMDAgMCBDIDIwIDAgMCAyMCAwIDEwMCBDIDAgMTgwIDIwIDIwMCAxMDAgMjAwIEMgMTgwIDIwMCAyMDAgMTgwIDIwMCAxMDAgQyAyMDAgMjAgMTgwIDAgMTAwIDAgWiIvPgoKPC9zdmc+)",
    },
    ".mask-decagon": {
    ...
    ".menu li.disabled>:hover": { backgroundColor: "transparent" },
    ...
    ".menu>:where(li)>:where(ul) :where(li) :where(ul)": { paddingRight: "1rem" },
    ...
    ".mockup-code pre": { paddingLeft: "1.25rem" },
    ".mockup-code pre:before": { content: '""', marginLeft: "2ch" },
    ...
    ".modal-action>:not([hidden])~:not([hidden])": {
        "-TwSpaceXReverse": "0",
        marginLeft: "calc(.5rem * var(--tw-space-x-reverse))",
        marginRight: "calc(.5rem * calc(1 - var(--tw-space-x-reverse)))",
    },
    ...
    ".range::-webkit-slider-thumb": {
        ...
        "-FillerOffset": ".6rem",
        boxShadow:
            "0 0 0 3px hsl(var(--range-shdw)) inset,var(--focus-shadow,0 0),calc(-1*(var(--filler-size) * -1 - var(--filler-offset))) 0 0 var(--filler-size)",
    },
    ...
    ".rating input": { appearance: "none", WebkitAppearance: "none" },
    ".rating .rating-hidden": { width: ".5rem", backgroundColor: "transparent" },
    ".rating input:checked~input": { "-TwBgOpacity": "0.2" },
    ...
    ".swap-flip": { transformStyle: "preserve-3d", perspective: "16em" },
    ...
    ".tab:focus-visible": {
        outline: "2px solid currentColor",
        outlineOffset: "-3px",
        borderBottomLeftRadius: "var(--tab-radius,.5rem)",
        borderBottomRightRadius: "var(--tab-radius,.5rem)",
    },
    ".tab-bordered": {
        borderColor: "hsl(var(--bc) / var(--tw-border-opacity))",
        "-TwBorderOpacity": "0.2",
    ...
    ".tab-lifted.tab-active:first-child:before": { background: "100% 0" },
    ".tab-lifted.tab-active:last-child:after": { background: "100% 0" },
    ...
    ".textarea-info:focus": { outline: "2px solid hsl(var(--inc))" },
    ".textarea-success": {
        "-TwBorderOpacity": "1",
        borderColor: "hsl(var(--suc,var(--nc)) / var(--tw-border-opacity))",
    },
    ".textarea-success:focus": { outline: "2px solid hsl(var(--suc))" },
    ".textarea-warning": {
        "-TwBorderOpacity": "1",
        borderColor: "hsl(var(--wac,var(--nc)) / var(--tw-border-opacity))",
    },
    ".textarea-warning:focus": { outline: "2px solid hsl(var(--wac))" },
    ".textarea-error": {
        "-TwBorderOpacity": "1",
        borderColor: "hsl(var(--erc,var(--nc)) / var(--tw-border-opacity))",
    },
    ".textarea-error:focus": { outline: "2px solid hsl(var(--erc))" },
    ...
    ".toggle:indeterminate": {
        ...
        "-TwBgOpacity": "1",
        boxShadow:
            "calc(-1*(var(--handleoffset)/ 2)) 0 0 2px hsl(var(--b1)) inset,calc(-1*(var(--handleoffset)/ -2)) 0 0 2px hsl(var(--b1)) inset,0 0 0 2px hsl(var(--b1)) inset",
    },
    ...
    ".tooltip.tooltip-open:after,.tooltip.tooltip-open:before,.tooltip:hover:after,.tooltip:hover:before":
        { opacity: "1", transitionDelay: "75ms" },
    ...
    ":root .prose": {
        "-TwProseBody": "hsl(var(--bc))",
        "-TwProseHeadings": "hsl(var(--b))",
        "-TwProseLead": "#4b5563",
        "-TwProseLinks": "hsl(var(--b))",
        "-TwProseBold": "hsl(var(--b))",
        "-TwProseCounters": "#6b7280",
        "-TwProseBullets": "hsla(var(--bc)/.5)",
        "-TwProseHr": "hsla(var(--bc)/.2)",
        "-TwProseQuotes": "hsl(var(--b))",
        "-TwProseQuoteBorders": "hsla(var(--bc)/.2)",
        "-TwProseCaptions": "#6b7280",
        "-TwProseCode": "hsl(var(--b))",
        "-TwProsePreCode": "hsla(var(--bc)/.2)",
        "-TwProsePreBg": "#1f2937",
        "-TwProseThBorders": "hsla(var(--bc)/.5)",
        "-TwProseTdBorders": "hsla(var(--bc)/.2)",
        "-TwProseInvertBody": "hsla(var(--bc)/.5)",
        "-TwProseInvertHeadings": "#fff",
        "-TwProseInvertLead": "#9ca3af",
        "-TwProseInvertLinks": "#fff",
        "-TwProseInvertBold": "#fff",
        "-TwProseInvertCounters": "#9ca3af",
        "-TwProseInvertBullets": "#4b5563",
        "-TwProseInvertHr": "hsl(var(--bc))",
        "-TwProseInvertQuotes": "#f3f4f6",
        "-TwProseInvertQuoteBorders": "hsl(var(--bc))",
        "-TwProseInvertCaptions": "#9ca3af",
        "-TwProseInvertCode": "#fff",
        "-TwProseInvertPreCode": "hsla(var(--bc)/.5)",
        "-TwProseInvertPreBg": "rgb(0 0 0 / 50%) )",
        "-TwProseInvertThBorders": "#4b5563",
        "-TwProseInvertTdBorders": "hsl(var(--bc))",
    },
    ".prose": { color: "inherit" },
    ...
    ".prose blockquote": { borderRightColor: "hsl(var(--bc) / 40%)" },
