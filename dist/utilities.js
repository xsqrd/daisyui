module.exports = {
    ...
    ".glass,.glass.btn-active,.glass:hover": {
        ...
        backgroundImage:
            "linear-gradient(135deg,rgb(255 255 255 / var(--glass-opacity,30%)) 0,rgb(0 0 0 / 0) 100%),linear-gradient(var(--glass-reflex-degree,100deg),rgb(255 255 255 / var(--glass-reflex-opacity,10%)) 25%,rgb(0 0 0 / 0) 25%)",
        boxShadow:
